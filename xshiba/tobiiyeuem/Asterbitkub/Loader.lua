getgenv().Team = "Pirates" getgenv().AutoLoad = false
print("Break");
...
Window = Fluent:CreateWindow({
    Title = "Aster Hub-Blox Fruit [ Premium ]",
...
ImageLabel.Image = "http://www.roblox.com/asset/?id= 75177922589625"
